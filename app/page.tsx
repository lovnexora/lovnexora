...
<footer className="mt-20 pt-8 border-t flex justify-between items-center font-mono text-xs" style={{ borderColor: 'var(--border-color)', color: 'var(--text-secondary)' }}>
  <div className="flex gap-6 items-center">
    ...
    <a href="https://www.linkedin.com/in/lov-nexora/" target="_blank" rel="noopener noreferrer" className="hover:text-emerald-500 dark:hover:text-white transition-colors" aria-label="LinkedIn">
      <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
